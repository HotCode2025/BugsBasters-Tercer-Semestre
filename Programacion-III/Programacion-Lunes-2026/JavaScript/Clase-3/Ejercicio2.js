...
class Monitor {
    ...
    constructor(marca, tamaño) {
        ...
        this._tamaño = tamaño;      // Tamaño de la pantalla en pulgadas (ej. 24, 27)
    }
...
class Orden {
    ...
    // Con el nuevo metodo toString()
    // Con este cambio, la clase Orden también participara en el ploimorfismo
    // Ahora, al convertir una Orden en texto, se invoca automáticamente el toString() de cada computadora,
    // y a su vez cada computadora invoca el toString() de sus componentes (monitor, teclado, ratón).
    toString() {
        let computadorasOrden = '';
        for (let computadora of this._computadoras) {
            computadorasOrden += `\n ${computadora}`; // aquí se invoca toString() de cada computadora
        }
        return `Orden: ${this._idOrden}, Computadoras: ${computadorasOrden}`;
    }

    // Este método ahora solo imprime usando el toString de la clase
    // Se simplifica el código y se aprovecha el polimorfismo
    mostrarOrden() {
...
// Instanciamos los diferentes componentes por separado brindándoles sus características correspondientes
...
// Pasamos los objetos creados anteriormente para construir objetos Computadora
...
console.log('\n--- Generando Órdenes ---');
// Creamos órdenes y usamos el método agregarComputadora para meter las PC en la orden
